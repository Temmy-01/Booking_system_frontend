...
export default function DashboardPage() {
  ...
  // Check if userData and its properties exist
  if (!userData || !userData.userInfo || !userData.userInfo.user) {
    return <div>Loading...</div>; // Or some other fallback UI
  }
  // Correctly declare and initialize user variable
                  ...
                  <div className="flex-grow-1">
                    <h4 className="fs-16 mb-1">
                      ...
                      <span className="text-info font-weight-bold">
                        {/* {userData.userInfo?.user.last_name} */}
                  ...
                  <div className="card-body p-0">
                    <div className="row row-cols-xxl-5 row-cols-md-4 row-cols-1 g-0">
                      ...
                      <div className="col">
                        <div className="mt-3 mt-md-0 py-4 px-3">
                          <h5 className="text-muted text-uppercase fs-13">
                            ...
                            <i className="ri-arrow-up-circle-line text-warning fs-18 float-end align-middle"></i>
                          </h5>
                          <div className="d-flex align-items-center">
                            <div className="flex-shrink-0">
                      ...
                      <div className="col">
                        <div className="mt-3 mt-md-0 py-4 px-3">
                          <h5 className="text-muted text-uppercase fs-13">
                            Total Sales for the Month (July){" "}
                            <i className="ri-arrow-down-circle-line text-warning fs-18 float-end align-middle"></i>
                          </h5>
                          <div className="d-flex align-items-center">
                            <div className="flex-shrink-0">
                  ...
                  <div className="card-body">
                    ...
                    <div className="d-flex mt-4">
                      ...
                      <div className="flex-grow-1 ms-3">
                        <h6 className="mb-1 lh-base">
                          <a href="#" className="text-reset">
                            The bitcoin-holding U.S. senator is trying to “fully
                            integrate” crypto{" "}
                          </a>
                        </h6>
                        <p className="text-muted fs-12 mb-0">
