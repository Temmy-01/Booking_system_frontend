...
import CreateCompRepo from "../../components/Modal/CreateCompRepo";
import axiosInstance from "../../hooks/axiosInstance";
import EditCompRepo from "../../components/Modal/EditCompRepo";
 ...
 const setCurrent = (data) => {
  ...
  useEffect(() => {
    const fetchRepositories = async () => {
      ...
      try {
        const response = await axiosInstance.get("/user/repository/fetch", {
          params: { page, filter },
        });
